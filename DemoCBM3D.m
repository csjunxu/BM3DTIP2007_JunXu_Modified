...
%     nSig = NoiseLevel( IMin*255);
    ...
    %% output
    imwrite(IMout, ['C:/Users/csjunxu/Desktop/CVPR2017/cc_Results/Real_CBM3D/CBM3D_BID_' IMname '.png']);
end
mPSNR = mean(PSNR);
mSSIM = mean(SSIM);
mCCPSNR = mean(CCPSNR);
mCCSSIM = mean(CCSSIM);
save(['C:/Users/csjunxu/Desktop/CVPR2017/cc_Results/Real_CBM3D_BID_CCNoise_15.mat'],'PSNR','mPSNR','SSIM','mSSIM','CCPSNR','mCCPSNR','CCSSIM','mCCSSIM');