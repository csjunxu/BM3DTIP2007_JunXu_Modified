...
% [1] M. M�kitalo and A. Foi, "Optimal inversion of the generalized Anscombe transformation for Poisson-Gaussian noise", IEEE Trans. Image Process., doi:10.1109/TIP.2012.2202675
%
...
for pp=1:numel(peaks)
    ...
    for i = 1:im_num
        ...
        %% output
        imwrite(yhat/peak, ['./BM3Dresults/PoiGau/BM3D_PoiGau_' IMname '_peak' num2str(peak) '_alpha' num2str(alpha) '.png']);
    ...
    matname = sprintf('./BM3Dresults/BM3D_PoiGau_%s_peak%d_alpha%1.1f.mat',IMname,peak,alpha);
