...
fpath = fullfile(Original_image_dir, 'vehicle_middle.png');
im_dir  = dir(fpath);
...
for i = 1: im_num
    ...
    for nh = listh
        for nw = listw
            ...
            [~, IMout_part_y] = BM3D(IMin_part_y, IMin_part_y, nSig);
            if ch==1
    ...
    %% output
    imwrite(IMout, ['C:/Users/csjunxu/Desktop/CVPR2017/1_Results/BM3D_Real_' IMname '.png']);
end